...
binary I will start with a basic logistic regression model. This model serves as a great
starting point in modelling since it is easy to implement, is easy to interpret. Then I will use a penalized
...
factors that have few observations (less than 1% of the data). This will help reduce
...
downsamp_grid<-grid_regular(under_ratio()%>%range_set(c(.5,1.5)),
                            levels=11)
smote_grid<-grid_regular(over_ratio()%>%range_set(c(.3,1.4)),
