...
# This finds the most balanced decision threshold by maximizing the true positive rate (sensitivity) minus # the false positive rate (1-specificity)
...
Only coefficients with a p-value less than .05 are included. The verticle black line indicates
...
deciding to purchse new car insurance.
