...
This plot shows the model parameter estimates for the best fitting downsample logistic regression model.
Only parameters with a p-value less than .05 are included. Unfortunately the actual values of the 
