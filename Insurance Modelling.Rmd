...
```{r}
# This finds the most balanced decision threshold by maximizing the true positive rate (specificity) minus # the false positive rate (1-sensitivity)
up_curve_cut<- up_curve$.threshold[which.max(sqrt(up_curve$sensitivity^2-(up_curve$specificity)^2))]
...
```{r fit data to test data set,warning=FALSE,message=FALSE} 
